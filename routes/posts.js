...
router.post('/comment/:id', [authMiddleware, commentValidation], postController.postComment);

router.delete('/comment/:id/:comment_id', authMiddleware, postController.deleteComment);
